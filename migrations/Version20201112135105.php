 ...
 */
final class Version20201112135105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD inscription_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE client ADD CONSTRAINT FK_C74404555DAC5993 FOREIGN KEY (inscription_id) REFERENCES inscription (id) ON DELETE SET NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C74404555DAC5993 ON client (inscription_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C74404555DAC5993');
        $this->addSql('DROP INDEX UNIQ_C74404555DAC5993 ON client');
        $this->addSql('ALTER TABLE client DROP inscription_id');
        $this->addSql('ALTER TABLE inscription DROP FOREIGN KEY FK_5E90F6D619EB6921');
